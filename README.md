...
**Status: v0.2.6 — preview, under active development.**

The **v0.2.6 release includes value and axis editing**, undo/redo, original-value
...
Version 0.2.6 recovers MS41 curves whose runtime axis differs from a stale or
missing table header. It preserves code-proven byte widths and prevents inferred
table shapes from covering established curves and parameters. Direct value and
referenced-axis editing beneath the 1D curve chart remains available, with
undo/redo and original-value display.
