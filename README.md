...
**Status: v0.2.1 — preview, under active development.**

The **v0.2.1 release includes value and axis editing**, undo/redo, original-value
...
Version 0.2.1 improves MS41 table addresses and axis assignments, adds a
**Swap X/Y** display control, and corrects column-major axis editing. Search
