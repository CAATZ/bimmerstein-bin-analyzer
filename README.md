...
**Status: v0.2.2 — preview, under active development.**

The **v0.2.2 release includes value and axis editing**, undo/redo, original-value
...
Version 0.2.2 improves MS41 axis addresses and generic table boundaries,
reduces false candidates, and adds MS41.1 checksum reference coverage.
