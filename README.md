...
**Status: v0.2.3 — preview, under active development.**

The **v0.2.3 release includes value and axis editing**, undo/redo, original-value
...
Version 0.2.3 recovers more MS41 parameters and curves from executable code,
corrects signed values and runtime-bound axes, and keeps table and sidebar
rows stable during double-click editing and promotion.
